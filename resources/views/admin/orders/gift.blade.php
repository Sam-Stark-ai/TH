...
<div class="page-body">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Gift Orders</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid list-product-view product-wrapper">
        ...
        <div class="card bg-primary text-white">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <div>
                <h4 class="mb-0">{{ $ordersgifts->total() }}</h4>
      ...
      <div class="col-md-3">
        <div class="card bg-success text-white">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <div>
                <h4 class="mb-0">${{ number_format($ordersgifts->sum('price'), 2) }}</h4>
      ...
      <div class="col-md-3">
        <div class="card bg-info text-white">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <div>
                <h4 class="mb-0">{{ $ordersgifts->where('created_at', '>=', now()->startOfDay())->count() }}</h4>
      ...
      <div class="col-md-3">
        <div class="card bg-warning text-dark">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <div>
                <h4 class="mb-0">{{ $ordersgifts->where('created_at', '>=', now()->startOfMonth())->count() }}</h4>
        ...
        <div class="card">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-md-6">
                <h5 class="mb-0">Gift Orders Management</h5>
              </div>
    ...
    <p><strong>Package Name:</strong> {{ $package['package_name'] ?? 'N/A' }}</p>
    <p><strong>Package ID:</strong> {{ $package['package_id'] ?? 'N/A' }}</p>
    <p><strong>Package Price:</strong> ${{ number_format($package['package_price'] ?? 0, 2) }}</p>
    <p><strong>Total Rings:</strong> {{ $package['rings_count'] ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-6">
                                  <h6 class="text-warning mb-3">Ring Specifications</h6>
                                  <p><strong>Female Rings:</strong> {{ $order->female_rings ?? 'Not specified' }}</p>
                                     <p><strong>Male Rings:</strong> {{ $order->male_rings ?? 'Not specified'}}</p>
