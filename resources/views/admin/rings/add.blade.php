              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Ring</li>
                  </ol>
                </div>
              </div>
            </div>
                          ...
                          <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                            <div class="sidebar-body">
                              <form class="row g-3 common-form" method="POST" action="{{ route('admin.ring.store') }}" >
                                @csrf
                                <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Ring Icon</label>
                                  <input class="form-control" name="icon" id="validationProductTitle" type="text" placeholder="Ring Icon" value="{{ old('icon') }}">
                                </div>
                                <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Ring Title</label>
                                  <input class="form-control" name="title" id="validationProductTitle" type="text" placeholder="Ring Title" value="{{ old('title') }}">
                                </div>
                                <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Ring Rings</label>
                                  <input class="form-control" name="rings_count" id="validationProductTitle" type="text" placeholder="Ring Rings" value="{{ old('rings_count') }}">
                                </div>
                                 <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Ring Couples Connected</label>
                                  <input class="form-control" name="couples_connected" id="validationProductTitle" type="text" placeholder="Ring Couples Connected" value="{{ old('couples_connected') }}">
                                </div>
                                <div class="col-md-12">
