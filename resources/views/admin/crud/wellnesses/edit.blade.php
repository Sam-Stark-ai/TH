              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Wellness</li>
                  </ol>
                </div>
              </div>
            </div>
                        ...
                        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                          <li class="nav-item"> <a class="nav-link active" id="detail-product-tab" data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product" aria-selected="false">
                              ...
                              <div class="product-tab-content">
                                <h6>Edit Wellness Details</h6>
                                <p>Edit Wellness title & description</p>
                              </div></a></li>
...
@php
  $isEdit = isset($wellness);
@endphp

<form method="POST" action="{{ $isEdit ? route('admin.wellness.update', $wellness->id) : route('admin.wellness.store') }}" enctype="multipart/form-data">
  @csrf
  @if ($isEdit)
    @method('PUT')
  @endif
  ...
  <div class="col-md-12">
    <label class="form-label" for="validationProductTitle">Wellness Title</label>
    <input
      class="form-control"
      name="title"
      ...
      type="text"
      placeholder="Title"
      value="{{ old('title', $wellness->title ?? '') }}"
    >
  </div>
  ...
  <div class="col-md-12">
    ...
    <textarea
      id="wellness_description"
      name="description"
      class="form-control"
      rows="6"
    >{!! old('description', $wellness->description ?? '') !!}</textarea>
  </div>

  <div class="col-md-6">
    <label class="form-label">Wellness Image</label>
    @if($wellness->image)
      <div class="mb-2">
        <img src="{{ asset('storage/' . $wellness->image) }}" alt="Current Image" style="max-width: 200px; height: auto; border-radius: 5px;">
  ...
  <div class="col-md-6">
    <label class="form-label">Wellness Icon</label>
    <input class="form-control" name="icon" type="text" placeholder="Icon" value="{{ old('icon', $wellness->icon ?? '') }}">
  </div>
...
@section('script')
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      CKEDITOR.replace('wellness_description', {
        toolbar: [
